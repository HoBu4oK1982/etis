                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                ...
                                @elseif ($image)
                                    <img src="{{ asset('assets/images/categories/' . $image) }}" width="180" alt="">
                                @else
                        ...
                        <div class="form-group">
                            <label class="admin__label font-weight-bold h5">СЕО заголовок</label>
                            <input type="text" class="form-control" wire:model="meta_title">
                            @error('meta_title') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label class="admin__label font-weight-bold h5">СЕО описание</label>
                            <textarea class="form-control" rows="3" wire:model="meta_description"></textarea>
                            @error('meta_description') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label class="admin__label font-weight-bold h5">СЕО ключевики</label>
